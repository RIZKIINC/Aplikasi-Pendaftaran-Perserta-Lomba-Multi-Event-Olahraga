        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div style="float: right;">
                    <a type="button" class="mdi mdi-file-pdf btn btn btn-outline-info btn-rounded" target="_blank" href="/peserta/pdf"> PDF</a>
                    <a type="button" class="mdi mdi-file-excel btn btn-outline-info btn-rounded" target="_blank" href="/peserta/excel"> Excel</a>
                    <a type="button" class="mdi mdi-printer btn btn-outline-info btn-rounded" target="_blank" href="/peserta/cetak"> Print</a>
                </div>
                </p>
