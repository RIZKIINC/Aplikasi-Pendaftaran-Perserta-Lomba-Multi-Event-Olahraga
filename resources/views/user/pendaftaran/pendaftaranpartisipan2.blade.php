        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-header-action">
                    <a data-collapse="#mycard-collapse-grup" class="btn btn-icon btn-info" href="#"><i class="fas fa-minus"></i></a>
                </div>
            </div>
            <div class="collapse show" id="mycard-collapse-grup">
                <div class="card-body">
                    <form action="{{ URL::to('mapdistrictsport/update/') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row">
                            <label for="id_sub_district" class="col-sm-3 col-form-label">Kecamatan</label>
                            <div class="col-9">
                                <input id="id_sub_district" name="id_sub_district" class="form-control" value="Nama Kecamatan" required="required" type="text" disabled>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input id="group_name" name="group_name" class="form-control here" value="Nama Grup" required="required" type="text" disabled>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="coach_name" class="col-sm-3 col-form-label">Nama Official Coach</label>
                            <div class="col-9">
                                <input id="coach_name" name="coach_name" class="form-control here" value="Nama Coach" required="required" type="text" disabled>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="group_name" class="col-sm-3 col-form-label">Status</label>
                            <div class="col-9">
                                <input id="group_name" name="group_name" class="form-control here" value="status" required="required" type="text" disabled>
                            </div>
                        </div>
