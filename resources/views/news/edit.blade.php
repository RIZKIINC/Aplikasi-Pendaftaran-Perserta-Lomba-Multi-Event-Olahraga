    ...
    <div class="section-body">
        <div class="col-12 col-md-12 col-lg-12 px-0">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ URL::to('news/update/' . $news->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="summernote-simple" name="description">{{ $news->description }}</textarea>
                        </div>
                        <div class="form-group">
