...
@section('content')
    ...
    <h1>Edit Data Kegiatan</h1>
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item active"><a href="{{ URL::to('event/index') }}">Daftar</a></div>
            <div class="breadcrumb-item active"><a href="{{ URL::to('event/create') }}">Tambah</a></div>
        </div>
    </div>
    <div class="section-body">
        <div class="col-12 col-md-12 col-lg-12 px-0">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ URL::to('event/update/' . $event->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            <label>Lokasi</label><span style="color: red">*</span>
                        ...
                        <a href="{{ URL::to('event/index') }}" class="btn btn-secondary">Batal</a>
